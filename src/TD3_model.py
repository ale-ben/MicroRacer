...
class TD3(Base_model):
    ...
    def get_actor(self):
        ...
        outputs = layers.Dense(self.num_actions, name="out", activation="tanh")(out)
    ...
    def train(self, total_iterations=50000, save_weights=True, save_name=None, plot_results=True):
        i = 0
        mean_speed = 0
        ep = 0
        avg_reward = 0
